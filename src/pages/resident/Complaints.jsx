      ...
      <div className="w-full min-w-0 max-w-full">
        ...
        <div className="mb-6 flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
          ...
          <div>
            ...
            <p className="mt-1 text-[11.5px] font-medium text-slate-400">
              Submit and track issues reported to society management.
            </p>
          </div>
            ...
            >
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full resize-none rounded-[9px] border border-slate-200 px-3 py-2.5 text-[11px] font-medium text-slate-700 outline-none transition placeholder:text-slate-300 focus:border-emerald-400 focus:ring-2 focus:ring-emerald-100"
                />
              </div>
        ...
        {(detailLoading || selectedComplaint) && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/40 p-4">
            ...
            <div className="w-full max-w-[550px] overflow-hidden rounded-[16px] bg-white shadow-xl">
...
function ComplaintStatus({ status }) {
  ...
  return (
    <span className="inline-flex items-center gap-1.5 rounded-full bg-slate-100 px-2.5 py-1 text-[9px] font-bold text-slate-600">
      <AlertCircle size={11} />
      {status || "Pending"}
    </span>
  );
