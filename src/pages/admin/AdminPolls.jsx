                  ...
                  >
                    ...
                    <div className="mt-4 flex gap-2 border-t border-[#e2d9df] pt-3">
                      ...
                      <button
                        ...
                        className="flex items-center justify-center rounded-[10px] border border-red-100 bg-white px-3 text-red-500 transition hover:bg-red-50"
                        title="Delete Poll"
                      >
                        <Trash2 size={15} />
                      </button>
                          ...
                          >
                            ...
                            {formData.options.length >
                              ...
                              <button
                                ...
                                className="flex h-9 w-9 shrink-0 items-center justify-center rounded-[10px] border border-red-100 text-red-500 transition hover:bg-red-50"
                              >
                                <Trash2 size={14} />
                              </button>
                            )}
